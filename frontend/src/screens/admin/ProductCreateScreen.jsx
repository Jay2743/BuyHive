...
const ProductCreateScreen = () => {
  ...
  return (
    <>
      <Link to="/admin/productlist" className="btn btn-light my-3 productCreateScreen__goBack--btn">
        Go Back
      </Link>
      <FormContainer>
        ...
        {lodingCreate && <Loader />}
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Button type="submit" variant="primary" className="my-2 productCreateScreen__create--btn">
              Create
            </Button>
          </Form>
